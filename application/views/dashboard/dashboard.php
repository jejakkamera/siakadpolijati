                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="foto" value="<?= $dosen_profile['foto'] ?>" class="form-control" id="foto">
                                    </div>
                                </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-block">
                            ...
                            <div class="button-container">
                                <a style="background-color: #FF8D19; border: 1px solid #FF8D19; height: 35px; display: flex; align-items: center; justify-content: center" href="<?php echo base_url('welcome/arp'); ?>" class="btn btn-primary">Academic Regulation</a>
                                <a style="background-color: #FF8D19; border: 1px solid #FF8D19; height: 35px; display: flex; align-items: center; justify-content: center" href="<?php echo base_url('welcome/rdd'); ?>" class="btn btn-primary">Regulation Decree and Documentation</a>
                            </div>
                        </div>
                    </div>
                </div>
