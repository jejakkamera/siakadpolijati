                        ...
                        <form action="<?php echo $data_detail['action']; ?>" method="post" enctype="multipart/form-data">
                            <?php foreach ($data_isi as $val) { ?>
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label"><?php echo $val['nama_form']; ?> <?php if ($val['required'] == 1) {
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        $input_select2_multi = array("multiple2");
                                        $input_upload = array("upload");
                                        if (in_array($val['tipe'], $input_)) { ?>

                                            <input type="<?php echo $val['tipe']; ?>" class="form-control" name="<?php echo $val['kode_form']; ?>" id="<?php echo $val['kode_form']; ?>" placeholder="<?php echo $val['placeholder']; ?>" <?php if ($val['required'] == 1) {
                                                                                                                                                                                                                                                echo "required";
                                                                                                                                                                                                                                            } ?> <?php if ($val['readonly'] == 1) {
                                                                                                                                                                                                                                                                                                    echo "readonly";
                                                                                                                                                                                                                                                                                                } ?> value="<?php if ($status && $data_master) {
                                                                                                                                                                                                                                                                                                                                                                    echo $data_master[$val['kode_form']];
                                                                                                                                                                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                                                                                                                                                                    echo set_value($val['kode_form']);
                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                ?>">
                                            <?php echo form_error($val['kode_form']); ?>
                                        <?php } else if (in_array($val['tipe'], $show_pdf)) { ?>
                                            <iframe src="<?php echo $val['kode_form']; ?>" height="500" width="100%"></iframe>
                                        <?php } else if (in_array($val['tipe'], $input_float)) { ?>

                                            <input type="number" step="0.01" class="form-control" name="<?php echo $val['kode_form']; ?>" id="<?php echo $val['kode_form']; ?>" placeholder="<?php echo $val['placeholder']; ?>" <?php if ($val['required'] == 1) {
                                                                                                                                                                                                                                        echo "required";
                                                                                                                                                                                                                                    } ?> <?php if ($val['readonly'] == 1) {
                                                                                                                                                                                                                                                                                            echo "readonly";
                                                                                                                                                                                                                                                                                        } ?> value="<?php if ($status && $data_master) {
                                        ...
                                        <?php } else if (in_array($val['tipe'], $input_upload)) { ?>
                                            <?php echo form_error($val['kode_form']); ?>
                                            <input type="file" class="form-control" name="<?php echo $val['kode_form']; ?>" id="<?php echo $val['kode_form']; ?>" placeholder="<?php echo $val['placeholder']; ?>" <?php if ($val['required'] == 1) {
                                                                                                                                                                                                                        echo "required";
                                                                                                                                                                                                                    } ?> <?php if ($val['readonly'] == 1) {
                                                                                                                                                                                                                                                                                echo "readonly";
                                                                                                                                                                                                                                                                            } ?> value="<?php if ($status && $data_master) {
											...
											<?php if ($status == 'update') {  ?>
												,<a target='_blank' href="<?php echo base_url($data_master[$val['kode_form']]);  ?>"><i class="fa fa-file"></i> File Before</a>
											<?php } ?>
											
                                        
											<?php } else if (in_array($val['tipe'], $input_tags)) { ?>

                                            <input type="text" class="form-control" name="<?php echo $val['kode_form']; ?>" id="<?php echo $val['kode_form']; ?>" <?php if ($val['readonly'] == 1) {
                                                                                                                                                                        echo "readonly";
                                                                                                                                                                    } ?> data-role="tagsinput" placeholder="<?php echo $val['placeholder']; ?>" <?php if ($val['required'] == 1) {
                                                                                                                                                                                                                                                                                                    echo "required";
                                                                                                                                                                                                                                                                                                } ?> value="<?php if ($status && $data_master) {
                                                                                                                                                                                                                                                                                                                                                                echo $data_master[$val['kode_form']];
                                                                                                                                                                                                                                                                                                                                                            } else {
                                        ...
                                        <?php } else if (in_array($val['tipe'], $input_wyswyg)) { ?>
                                            <?php echo form_error($val['kode_form']); ?>
                                            <textarea <?php if ($val['required'] == 1) {
                                                            echo "required";
                                                        } ?> class="summernote" name="<?php echo $val['kode_form']; ?>" id="<?php echo $val['kode_form']; ?>">
                            <?php if ($status && $data_master) {
                                                echo $data_master[$val['kode_form']];
                                            } else {
                                                echo set_value($val['kode_form']);
                                            }
                            ?>
                                        ...
                                        <?php } else if (in_array($val['tipe'], $input_date)) { ?>
                                            ...
                                            <?php echo form_error($val['kode_form']); ?>
                                            <input type="text" <?php if ($val['required'] == 1) {
                                                                    echo "required";
                                                                } ?> name="<?php echo $val['kode_form']; ?>" id="<?php echo $val['kode_form']; ?>" class="form-control mydatepicker" placeholder="yyyy-mm-dd" <?php if ($val['readonly'] == 1) {
                                                                                                                                                                                                                                                                    echo "readonly";
                                                                                                                                                                                                                                                                } ?> value="<?php if ($status && $data_master) {
                                                                                                                                                                                                                                                                                                                                echo $data_master[$val['kode_form']];
                                                                                                                                                                                                                                                                                                                            } else {
                                        ...
                                        <?php } else if (in_array($val['tipe'], $input_select)) { ?>
                                            <?php echo form_error($val['kode_form']); ?>
                                            <select <?php if ($val['required'] == 1) {
                                                        echo "required";
                                                    } ?> <?php if ($val['readonly'] == 1) {
                                                                                                                echo "disabled";
                                                                                                            } ?> name="<?php echo $val['kode_form']; ?>" id="<?php echo $val['kode_form']; ?>" require class="js-data-example-ajax-<?php echo $val['kode_form']; ?> form-control" style="width: 100%">

                                                <?php foreach ($val['select_data'] as $row) { ?>
                                                    <option value="<?php echo $row['id']; ?>" <?php if ($status && $data_master) {
                                                                                                    if ($data_master[$val['kode_form']] == $row['id']) {
                                        ...
                                        <?php } else if (in_array($val['tipe'], $input_select2_multi)) { ?>
											<?php echo form_error($val['kode_form']); ?>
                                            <select multiple="multiple" <?php if ($val['readonly'] == 1) {
                                                        echo "disabled";
