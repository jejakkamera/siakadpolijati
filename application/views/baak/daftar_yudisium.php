                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block wizard-content">
                                <h4  class="card-title">Form Yudisium <a class="btn btn-info" target="_blank" href="<?php echo base_url('/assets/berkas/yudisium/'.$data_master->berkas); ?>" > Berkas </a> || <a class="btn btn-danger" href="<?php echo base_url('baak/tugas_akhir/ta_s1/tolak_yudisium/'.$id_trx.'/'.$periode); ?>" > Tolak Ajuan </a></h4>
