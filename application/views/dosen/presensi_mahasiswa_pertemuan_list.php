                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <button  class="btn btn-success waves-effect waves-light" ><span class="btn-label"><i class="fa fa-save"></i></span> Save</button>
                                    ...
                                    <table id="mytable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        foreach($list_mhs as $row){ 
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <input <?php if(!$row->$presensi_status){echo "checked";} if($row->$presensi_status=='hadir'){echo "checked";} ?> type="radio"  name="presensi_status_<?php  echo $row->nim; ?>" value="hadir">
                                    ...
                                    <b>* Mahasiswa dengan status Suspend dapat menghubungi BAAK </b>
                                </div>
                            </div>
                        </div>
