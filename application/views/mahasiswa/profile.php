				...
				<div class="card card-block printableArea">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<a href="<?php echo base_url('mahasiswa/profile/kartu_mhs/'.$data->nim); ?>" target="_blank" rel="noopener noreferrer" class="btn btn-success"><i class="fa fa-id-card"></i> Kartu Mahasiswa</a>
										...
										<table class="table table-striped">
											...
											<tr>
												<td><a class="btn btn-primary mb-3" href="" data-toggle="modal"
														data-target="#exampleModal">Ubah Data</a></td>
											</tr>
								...
								<div class="tab-pane fade" id="orang_tua" role="tabpanel"
									...
									<div class="table-responsive">
										<table class="table table-striped">
											...
											<tr>
												<td><a class="btn btn-primary mb-3" href="" data-toggle="modal"
														data-target="#exampleModal2">Ubah Data</a></td>
											</tr>
										</table>
									</div>
								</div>
								<div class="tab-pane fade" id="wali" role="tabpanel" aria-labelledby="wali-tab">
									<div class="table-responsive">
										<table class="table table-striped">
											...
											<tr>
												<td><a class="btn btn-primary mb-3" href="" data-toggle="modal"
														data-target="#exampleModal3">Ubah Data</a></td>
											</tr>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModal2Label"
	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModal2Label">Ubah Data Orang Tua</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
