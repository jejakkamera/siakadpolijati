                                            ...
                                            foreach($pembayaran as $row){ ?>
                                                <tr>
                                                    ...
                                                    <td><?php if($row->total_tagihan-$row->total_bayar!=0 AND $tagihan==0){
                                                        ...
                                                        $tagihan=1;?>
                                                        <form method="post"  onsubmit="return validateForm()" action="<?php echo base_url('mahasiswa/administrasi/ukt_generate_tagihan/'.$row->kode_periode); ?>">
                                                        
                                                        
                                                        <input type="number"  name="total_bayar" id="total_bayar" />
                                                        <input type="hidden"  name="periode" id="periode" value="<?php echo $row->kode_periode; ?>" />
