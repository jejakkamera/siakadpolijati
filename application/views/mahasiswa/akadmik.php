                                    ...
                                    <table id="mytable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $info_akademik->tempat_lahir; ?>, <?php echo $info_akademik->tanggal_lahir; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Agama</td>
                                                <td><?php echo $info_akademik->nama_agama; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Nama Ibu</td>
                                                <td><?php echo $info_akademik->nama_ibu_kandung; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Kelas</td>
