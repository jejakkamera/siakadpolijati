								...
								<table class="table table-hover">
									<thead>
										<tr>
											...
											<th class="text-center">Kehadiran Online</th>
                                    ...
                                    <?php foreach($kurikulum as $row){ ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $row->sks_mata_kuliah;?></td>
                                            <td class="text-center"><a href="<?php echo base_url('mahasiswa/perkuliahan/kehadiran_online/'.$row->id_trx); ?>" class="btn btn-info">Kehadiran Onlie</a> <br> </td>
												<td>
