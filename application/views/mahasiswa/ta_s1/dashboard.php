                            ...
                            <h2 align="center">Bimbingan & Jadwal Sidang</h2>
                                ...
                                <div class="tab-content tabcontent-border">
                                    ...
                                    <?php if(  $this->session->userdata('role')=='mhs' ){ ?>
                                        <a href="<?php echo base_url(); ?>mahasiswa/ta_s1/add_bimbingan/<?php echo $data_masters->nim ?>/<?php echo $data_masters->periode; ?>" class="btn btn-block btn-warning">Add Bimbingan</a>
                                    <?php }else{  ?> 
                                        <a href="<?php echo base_url(); ?>dosen/ta_s1/add_bimbingan/<?php echo $data_masters->nim ?>/<?php echo $data_masters->periode; ?>" class="btn btn-block btn-warning">Add Bimbingan</a>
                                    <?php } ?> 
                                    <br>
                                    ...
                                    <table id="mytable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Lunas UKT <a href="<?php echo base_url(); ?>mahasiswa/administrasi/ukt/" class="btn btn-block btn-info">Cek UKT</a></td>
