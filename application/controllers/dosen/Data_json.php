...
class Data_json extends CI_Controller {
    ...
    public function json_copy_draf($periode,$id_trx)
    {
        $this->load->model('datatable/Dosen_dt', 'Dosen_dt');
        
        header('Content-Type: application/json');
        //echo $this->session->userdata('username');
        echo $this->Dosen_dt->json_copy_draf($periode,$id_trx);
    }

    public function json_perangkat_perkuliahan($periode)
    {
        $this->load->model('datatable/Dosen_dt', 'Dosen_dt');
        
        header('Content-Type: application/json');
        //echo $this->session->userdata('username');
        echo $this->Dosen_dt->json_perangkat_perkuliahan($periode);
    }
    ...
    public function json_perangkat_perkuliahan_periode()
    {
        $this->load->model('datatable/Dosen_dt', 'Dosen_dt');
        
        header('Content-Type: application/json');
        echo $this->Dosen_dt->json_perangkat_perkuliahan_periode();
    }
