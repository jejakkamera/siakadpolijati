...
{ //baku
    ...
    function list_profile_update()
    {
        if ($this->session->userdata('role') == 's_a') {
            $data_detail = array(
                'link_json' => base_url('baak/data_json/json_profile_mahasiswa'),
                'header' => 'Profile Mahasiswa',
                'tabel_detail' => 'Profile Mahasiswa',

                'button_name' => 'Update Biodata Mahasiswa',
                'button_action_link' => base_url('admin/feeder/f_UpdateBiodataMahasiswa'),
            ...
            $data_detail = array(
                ...
                'button_name' => 'List Mahasiswa',
                'button_action_link' => base_url('baak/mahasiswa/'),
                'button_icon' => 'fa fa-list',
            );
        }
    ...
    function mahasiswa()
    {
        $data_detail = array(
            ...
            'button_name' => 'Profile Update',
            'button_action_link' => base_url('baak/mahasiswa/list_profile_update/'),
            'button_icon' => 'fa fa-list',

            'button_name2' => 'Pengajuan Cuti',
            'button_action_link2' => base_url('baak/mahasiswa/list_cuti_baak/'),
            'button_icon2' => 'fa fa-list',

            'button_name3' => 'Pengajuan Aktif',
            'button_action_link3' => base_url('baak/mahasiswa/list_aktif/'),
            'button_icon3' => 'fa fa-list',
        );
    ...
    function list_cuti_baak()
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_mahasiswa_cuti'),
            'header' => 'Master Data Mahasiswa',
            'tabel_detail' => 'Master Data Mahasiswa',
            ...
            'button_name2' => 'Report',
            'button_action_link2' => base_url('baak/mahasiswa/report_cuti_baak/'),
    ...
    function suspend_mahasiswa()
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_suspend_mahasiswa'),
            'header' => 'Master Data suspend_mahasiswa',
            'tabel_detail' => 'Master Data suspend_mahasiswa',

            'button_name' => 'Add Suspend',
            'button_action_link' => base_url('baak/pembelajaran/add_suspend_mahasiswa_select/'),
    ...
    function set_kurikulum($periode, $report)
    {
        ...
        $data_detail = array(
            ...
            'button_name2' => 'RSP Proses',
            'button_action_link2' => base_url('baak/frs/rps_proses/' . $periode),
            'button_icon2' => 'fa fa-address-book',
    ...
    function jadwal_dosen_all($periode)
    {
        $data_detail = array(
            ...
            'header' => 'Ploting Dosen periode : '.$periode,
            'tabel_detail' => 'Ploting Dosen periode : '.$periode,
    ...
    function rps_proses($periode)
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_rps_proses/' . $periode),
            'header' => 'RPS Proses',
            'tabel_detail' => 'RPS Proses',
    ...
    function mahasiswa_perwalian_by_nim($nim)
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_mahasiswa_perwalian_by_nim/' . $nim),
            'header' => 'data Perwalian Mahasiswa ' . $nim,
            'tabel_detail' => 'data Perwalian Mahasiswa ' . $nim,

            'button_name' => 'Add Perwalian',
            'button_action_link' => base_url('baak/mahasiswa/perwalian_add/' . $nim),
            'button_icon' => 'fa fa-plus',
        ...
        $data_isi = array(
            ...
            [
                'code_nama' => 'input_date',
                'nama' => 'tanggal Perwalian',
                'orderable' => '1',
            ],
            [
                'code_nama' => 'topik_pewralian',
                'nama' => 'topik Perwalian',
                'orderable' => '1',
            ],
            [
                'code_nama' => 'keterangan',
    ...
    function list_perwalian_by_mahasiswa()
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_list_perwalian_by_mahasiswa'),
            'header' => 'Data Perwalian',
            'tabel_detail' => 'Data Perwalian',

            'button_name' => 'Add Perwalian',
            'button_action_link' => base_url('/mahasiswa/perkuliahan/perwalian_add/'),
            'button_icon' => 'fa fa-plus',
        );
        $data_isi = array(
            [
            ...
            [
                'code_nama' => 'keterangan',
                'nama' => 'Konten Perwalian',
                'orderable' => '1',
            ],
            [
                'code_nama' => 'email_dosen',
                'nama' => 'Penginputan Perwalian',
                'orderable' => '1',
            ],
        );
    ...
    function list_jadwal_by_mahasiswa($periode)
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_list_jadwal_by_mahasiswa/' . $periode),
            'header' => 'Data Jadwal Perkuliahan',
            'tabel_detail' => 'Data Jadwal Perkuliahan',
        );
        $data_isi = array(
            [
                'code_nama' => 'nama',
    ...
    function list_jadwal_by_dosen($periode)
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_list_jadwal_by_dosen/' . $periode),
            'header' => 'Data Jadwal Perkuliahan',
            'tabel_detail' => 'Data Jadwal Perkuliahan',
        );
        $data_isi = array(
    ...
    function perkuliahan_periode()
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_perkuliahan_periode'),
            'header' => 'Master Periode :',
            'tabel_detail' => 'Master Periode :',

            'button_name' => 'Hide periode',
            'button_action_link' => base_url('/baak/baak/unhide_periode'),
            'button_icon' => 'fa fa-eye-slash',
        );
    ...
    function unhide_periode()
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_unhide_periode'),
            'header' => 'Master Periode :',
            'tabel_detail' => 'Master Periode :',

            'button_name' => 'Master Periode',
            'button_action_link' => base_url('/baak/baak/perkuliahan_periode'),
            'button_icon' => 'fa fa-arrow-left',
        );
    ...
    function mahasiswa_aktif_by_nim($nim)
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_mahasiswa_aktif_by_nim/' . $nim),
            'header' => 'Surat Mahasiswa Aktif :',
            'tabel_detail' => 'Surat Mahasiswa Aktif :',

            'button_name' => 'Add Surat Mahasiswa Aktif',
            'button_action_link' => base_url('/mahasiswa/perkuliahan/add_mahasiswa_aktif/'),
            'button_icon' => 'fa fa-plus',
        );
        $data_isi = array(
            [
    ...
    function list_permohonan_magang()
    {
        $data_detail = array(
            'link_json' => base_url('baak/magang/json_list_permohonan_magang/'),
            'header' => 'Permohonan Magang',
            'tabel_detail' => 'Permohonan Magang',

            'button_name' => 'Create Permohonan Magang',
            'button_action_link' => base_url('baak/magang/periode_magang_add/'),
            'button_icon' => 'fa fa-plus',
        );
        $data_isi = array(
    ...
    function list_skpi_by_mahasiswa($nim)
    {
        $data_detail = array(
            'link_json' => base_url('/baak/data_json/json_list_skpi_by_mahasiswa/' . $nim),
            'header' => 'List SKPI Mahasiswa ' . $nim,
            'tabel_detail' => 'List SKPI Mahasiswa ' . $nim,
    ...
    {
        $data_detail = array(
            'link_json' => base_url('/baak/data_json/json_list_mbkm'),
            'header' => 'List MBKM',
    ...
    function surat_kelulusan($nim)
    {
        $data_detail = array(
            'link_json' => base_url('baak/data_json/json_surat_kelulusan/' . $nim),
            'header' => 'Surat Kelulusan',
            'tabel_detail' => 'Surat Kelulusan',

            'button_name' => 'Add Surat Kelulusan',
            'button_action_link' => base_url('/mahasiswa/perkuliahan/add_surat_kelulusan/'),
            'button_icon' => 'fa fa-plus',
        );
        $data_isi = array(
    ...
    {
        $data_detail = array(
            'link_json' => base_url('/mahasiswa/cuti/json_list_cuti'),
            'header' => 'List Pengajuan Cuti',
            'tabel_detail' => 'List Pengajuan Cuti',

            'button_name2' => 'Pengajuan Cuti',
            'button_action_link2' => base_url('/mahasiswa/cuti/add'),
            'button_icon2' => 'fa fa-plus',
        );
        $data_isi = array(
            [
