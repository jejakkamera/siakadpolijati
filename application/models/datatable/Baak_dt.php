...
class Baak_dt extends CI_Model
{
    ...
    function json_mahasiswa_cuti()
    {
        $this->datatables->select('v_mahasiswa.nim, v_mahasiswa.nama, id_mahasiswa, id_registrasi_mahasiswa, id_periode_masuk, kode_prodi, nama_program_studi, nama_jenjang_pendidikan, status_mahasiswa, id_kurikulum,nama_kurikulum, info,list_mahasiswa_cuti.periode,id_uuid,list_mahasiswa_cuti.status');
        $this->datatables->from('list_mahasiswa_cuti');
        $this->datatables->join('v_mahasiswa', 'list_mahasiswa_cuti.nim=v_mahasiswa.nim');
        $this->datatables->where('list_mahasiswa_cuti.status', 'Waitlisted');
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/mahasiswa/cuti_validate/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="Validasi" class="btn btn-success"'
            ),
            'id_uuid'
        );
    ...
    function json_list_cuti()
    {
        ...
        if ($this->session->userdata('role') == 'mhs') {
            $this->datatables->where('list_mahasiswa_cuti.nim', $this->session->userdata('username'));
        }
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('welcome/surat_keterangan_mahasiswa_cuti/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="List Matakuliah Kurikulum" class="btn btn-success"'
            ),
            'id_uuid'
        );
    ...
    function json_kurikulum()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/matakuliah/kurikulum_matakuliah/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="List Matakuliah Kurikulum" class="btn btn-success"'
            ) .
                anchor(
                    site_url('baak/matakuliah/update_kurikulum/$1'),
                    '<i class="fa fa-pencil"></i>',
                    'data-toggle="tooltip" data-html="true" title="Update Kurikulum" class="btn btn-warning"'
                ),
            'id_kurikulum'
        );
    ...
    function json_kurikulum_mahasiswa()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/mahasiswa/plot_kurikulum/$1'),
                '<i class="fa fa-random"></i>',
                'data-toggle="tooltip" data-html="true" title="Plot Kurikulum mahasiswa" class="btn btn-success"'
            ),
            'id_kurikulum'
        );
        return $this->datatables->generate();
    ...
    function json_kurikulum_mahasiswa_set($periode, $report)
    {
        $this->datatables->select(
            'kode_program_studi, nama_program_studi, nama_jenjang_pendidikan, v_kurikulum.id_kurikulum, nama_kurikulum,v_kurikulum.id_semester,
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/frs/plot_set_kurikulum/$1/$2'),
                '<i class="fa fa-random"></i> MK',
                'data-toggle="tooltip" data-html="true" title="Matakuliah Saji" class="btn btn-success"'
            ) . " " .
                anchor(
                    site_url('baak/frs/jadwal_dosen/$1/$2/' . $report),
                    '<i class="fa fa-graduation-cap"></i> Jadwal',
                    'data-toggle="tooltip" data-html="true" title="Jadwal Dosen" class="btn btn-info"'
                ),
    ...
    function json_kurikulum_matakuliah($id_kurikulum)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/matakuliah/update_matakuliah/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Update Mata Kuliah" class="btn btn-warning"'
            ),
            'id_matkul'
        );
        return $this->datatables->generate();
    ...
    function json_prodi()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/prodi/prodi_info/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="Login Info" class="btn btn-success"'
            ) .
                anchor(
                    site_url('baak/prodi/update_prodi/$1'),
                    '<i class="fa fa-pencil"></i>',
                    'data-toggle="tooltip" data-html="true" title="Login Info" class="btn btn-warning"'
                ),
            'id_prodi'
        );
        return $this->datatables->generate();
    ...
    function json_prodi_presensi_dosen()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/pembelajaran/presensi_jadwal_prodi/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Presensi Dosen" class="btn btn-success"'
            ),
            'kode_program_studi'
        );
        return $this->datatables->generate();
    ...
    function json_prodi_presensi_mahasiswa()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/pembelajaran/presensi_matakuliah_prodi/$1'),
                '<i class="fa fa-user"></i>',
                'data-toggle="tooltip" data-html="true" title="Presensi Dosen" class="btn btn-info"'
            ),
            'kode_program_studi'
        );
        return $this->datatables->generate();
    ...
    function json_dosen()
    {
        $this->datatables->select('nip, id_dosen, nama, nidn, jabatan_struktural, id_status_aktif, id_sdm, created_at, email, status_pegawai, id, homebase, foto, nama_homebase,if(email is NULL,0,email) as status_email,nama_status_aktif');
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/dosen/dosen_info/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="Login Info" class="btn btn-success"'
            ) . " " .
                anchor(
                    site_url('baak/dosen/dosen_update/$1'),
                    '<i class="fa fa-pencil"></i>',
                    'data-toggle="tooltip" data-html="true" title="Login Info" class="btn btn-warning"'
                ) . " " .
                anchor(
                    site_url('baak/dosen/dosen_hapus/$1'),
                    '<i class="fa fa-trash"></i>',
                    'data-toggle="tooltip" data-html="true" title="Hapus Data Dosen" class="btn btn-danger"'
                ),
            'id'
        );
        return $this->datatables->generate();
    ...
    function json_dosen_wali_mahasiswa()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/mahasiswa/plot_dosen_wali/$1/$2'),
                '<i class="fa fa-random"></i>',
                'data-toggle="tooltip" data-html="true" title="Plot Dosen Wali" class="btn btn-success"'
            ),
            'id,homebase,nama'
        );
        return $this->datatables->generate();
    ...
    function json_suspend_mahasiswa()
    {
        $this->datatables->select('v_mahasiswa.nim, v_mahasiswa.nama, id_mahasiswa, id_registrasi_mahasiswa, id_periode_masuk, kode_prodi, nama_program_studi, nama_jenjang_pendidikan, status_mahasiswa, id_kurikulum,nama_kurikulum, info');
        $this->datatables->from('v_mahasiswa');
        $this->datatables->where('suspend', 'yes');
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/pembelajaran/suspend_mahasiswa_cancel_action/$1'),
                '<i class="fa fa-trash"></i>',
                'data-toggle="tooltip" data-html="true" title="Cancel Suspend" class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure cancel suspend $1 ?  \')"'
            ),
            'nim'
        );
        return $this->datatables->generate();
    ...
    function json_profile_mahasiswa()
    {
        $this->datatables->select('update,v_mahasiswa.nim, v_mahasiswa.nama, id_mahasiswa, id_registrasi_mahasiswa, id_periode_masuk, kode_prodi, nama_program_studi, nama_jenjang_pendidikan, status_mahasiswa, id_kurikulum,nama_kurikulum, info');
        $this->datatables->from('v_mahasiswa');
        $this->datatables->join('mahasiswa_profile', 'mahasiswa_profile.nim=v_mahasiswa.nim');
        $this->datatables->where('mahasiswa_profile.update', 'yes');
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/mahasiswa/profile_mahasiswa_update/$1'),
                '<i class="fa fa-check"></i>',
                'data-toggle="tooltip" data-html="true" title="Sudah di proses" class="btn btn-success"'
            ),
            'nim'
        );
        return $this->datatables->generate();
    ...
    function json_mahasiswa()
    {
        ...
        // $this->datatables->like('status_mahasiswa', ($this->session->userdata('mahasiswa_filter')['status_mahasiswa']) ? $this->session->userdata('mahasiswa_filter')['status_mahasiswa'] : "AKTIF");
        // $this->datatables->like('status_mahasiswa',  $this->session->userdata('mahasiswa_filter')['status_mahasiswa']);
        if (isset($this->session->userdata('mahasiswa_filter')['status_mahasiswa']) != NULL) {
        } else {
            $this->datatables->like('status_mahasiswa', 'AKTIF');
        }
        $this->datatables->like('id_periode_masuk', isset($this->session->userdata('mahasiswa_filter')['id_periode_masuk']));
        $text = 
                anchor(
                    site_url('baak/mahasiswa/transkrip_akademik/$1'),
                    '<i class="fa fa-graduation-cap"></i>',
                    'data-toggle="tooltip" data-html="true" title="KHS & FRS" class="btn btn-info"'
                ) . " " .
                anchor(
                    site_url('baak/mahasiswa/perwalian/$1'),
                    '<i class="fa fa-address-card"></i>',
                    'data-toggle="tooltip" data-html="true" title="Perwalian" class="btn btn-primary" '
                ) . " " .
                anchor(
                    site_url('baak/mahasiswa/skpi/$1'),
                    '<i class="fa fa-book"></i>',
                    'data-toggle="tooltip" data-html="true" title="Skpi" class="btn btn-warning" '
				)
		;
		if ($this->session->userdata('role') == 'pegawai_baak') {
			$text= '<div class="btn-group" role="group"> <button id="btnGroupDrop1" type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-toggle="tooltip" data-html="true" title="Account Mahasiswa"> <i class="fa fa-eye"></i></button><div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
					<a class="dropdown-item" href="'.site_url('baak/mahasiswa/mahasiswa_info/$1').'">Reset Password</a>
					<a class="dropdown-item" href="'.site_url('baak/mahasiswa/mahasiswa_loginas/$1').'">Login As $1</a>
					<a class="dropdown-item" href="'.site_url('baak/mahasiswa/profile/$1').'">Profile $1</a> <hr>
					<a class="dropdown-item" href="'.site_url('baak/mahasiswa/mahasiswa_hapus_action/$1').'">Hapus Mahasiswa $1</a>
				</div></div>'
			. " " .$text;
		}else{
			$text= '<div class="btn-group" role="group"> <button id="btnGroupDrop1" type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-toggle="tooltip" data-html="true" title="Account Mahasiswa"> <i class="fa fa-eye"></i></button><div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
					<a class="dropdown-item" href="'.site_url('baak/mahasiswa/profile/$1').'">Profile $1</a>
					<a class="dropdown-item" href="'.site_url('baak/mahasiswa/mahasiswa_loginas/$1').'">Login As $1</a>
				</div></div>'
			. " " .$text;
		}
    ...
    function json_list_pengisian_frs_mhs()
    {
        if ($this->session->userdata('frs_filter')['id_periode_masuk']) {
            $this->datatables->select('periode,id_trx,nim,id_mahasiswa,nama,status_frs,status_feeder,nilai_huruf,nilai_angka,kode_mata_kuliah,nama_mata_kuliah,semester,input_trx,nama_kelas');
    ...
    function json_list_pengisian_frs_mk()
    {
        if ($this->session->userdata('frs_filter')['id_periode_masuk']) {
            ...
            $this->datatables->add_column(
                'action',
                anchor(
                    site_url('baak/frs/kehadiran_mahasiswa_report_mk/$1/$2'),
                    '<i class="fa fa-list"></i>',
                    'data-toggle="tooltip" data-html="true" title="List Mahasiswa" class="btn btn-success"'
                ),
                'id_matkul,periode'
            );
            return $this->datatables->generate();
    ...
    function json_kelas()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/mahasiswa/plot_kelas/$1/$2'),
                '<i class="fa fa-random"></i>',
                'data-toggle="tooltip" data-html="true" title="Plot Kelas" class="btn btn-success"'
            ) . ' || ' .
                anchor(
                    site_url('baak/mahasiswa/delete_kelas/$1/$2'),
                    '<i class="fa fa-trash"></i>',
                    'data-toggle="tooltip" data-html="true" title="Delete Kelas" class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure Copy $1 ? all your data will be deleted \')"'
                ),
            'id_kelas,kode_prodi'
        );
        //$this->datatables->group_by('id_prodi');
    ...
    function json_skala_nilai()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/baak/list_skala_nilai_detail/$1'),
                '<i class="fa fa-plus"></i>',
                'data-toggle="tooltip" data-html="true" title="List Skala" class="btn btn-success"'
            ) . " " .
                anchor(
                    site_url('baak/baak/copy_skala_nilai/$1'),
                    '<i class="fa fa-copy"></i>',
                    'data-toggle="tooltip" data-html="true" title="Copy skala" class="btn btn-info" onclick="javasciprt: return confirm(\'Are You Sure Copy $1 ? all your data will be deleted \')"'
                ),
            'id_semester'
        );
    ...
    function json_skala_nilai_detail($periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/baak/skala_nilai_delete/$1'),
                '<i class="fa fa-trash"></i>',
                'data-toggle="tooltip" data-html="true" title="Copy skala" class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure Delete $1  ?\')"'
            ),
            'id'
        );
        return $this->datatables->generate();
    ...
    function json_kurikulum_saji_jadwal($id_kurikulum, $periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/frs/plot_jadwal_dosen/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="Jadwal" class="btn btn-danger" '
            ) . " | " .
                anchor(
                    site_url('baak/frs/nilai_mahasiswa_report/$1'),
                    '<i class="fa fa-book"></i> ',
                    'target="_blank" data-toggle="tooltip" data-html="true" title="Report nilai" class="btn btn-warning" '
                ) . " | " .
                anchor(
                    site_url('baak/frs/kehadiran_mahasiswa_report/$1'),
                    '<i class="fa fa-list"></i>',
                    'data-toggle="tooltip" data-html="true" title="Report Kehadiran mahasiswa" class="btn btn-info" '
                ),
            'id_trx'
        );
        return $this->datatables->generate();
    ...
    {
        $this->datatables->select('id_trx_jadwal,nama_program_studi,kode_mata_kuliah,nama_mata_kuliah,hari,nama_waktu,ruang,nama_kelas,angkatan,nama_id_dosen,status_rps');
        $this->datatables->from('v_jadwal');
        $this->datatables->where('periode', $periode);
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/frs/rps/$1'),
                '<i class="fa fa-address-book"></i> ',
                'target="_blank" data-toggle="tooltip" data-html="true" title="RPS" class="btn btn-info" '
            ) . " | " .
                anchor(
                    site_url('dosen/perkuliahan/input_nilai_select/$1'),
                    '<i class="fa fa-pencil"></i> ',
                    'target="_blank" data-toggle="tooltip" data-html="true" title="Input nilai" class="btn btn-warning" '
                ) ." ".
                anchor(
                    site_url('baak/frs/nilai_mahasiswa_report_jadwal/$1'),
                    '<i class="fa fa-book"></i> ',
                    'target="_blank" data-toggle="tooltip" data-html="true" title="Report nilai" class="btn btn-warning" '
                ) . " | " .
                anchor(
                    site_url('baak/frs/kehadiran_mahasiswa_report_jadwal/$1'),
                    '<i class="fa fa-list"></i>',
                    'data-toggle="tooltip" data-html="true" title="Report Kehadiran mahasiswa" class="btn btn-info" '
                ),
            'id_trx_jadwal'
    ...
    function json_rps_proses($periode)
    {
        $this->datatables->select('id_trx_jadwal,nama_program_studi,kode_mata_kuliah,nama_mata_kuliah,hari,nama_waktu,ruang,nama_kelas,angkatan,nama_id_dosen,status_rps');
        $this->datatables->from('v_jadwal');
        $this->datatables->where('periode', $periode);
        $this->datatables->where('status_rps', 'proses');
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/frs/rps/$1'),
    ...
    function json_waktu_kuliah()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/baak/waktu_kuliah_edit/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit Waktu Kuliah" class="btn btn-warning" '
            ) . " | " .

                anchor(
                    site_url('baak/baak/waktu_kuliah_delete/$1'),
                    '<i class="fa fa-trash"></i>',
                    'data-toggle="tooltip" data-html="true" title="Waktu Kuliah" class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure Delete $1 ?  \')" '
                ),
            'id'
        );
        return $this->datatables->generate();
    ...
    function json_presensi_jadwal_prodi($kode_prodi)
    {
        ...
        $this->datatables->add_column(
            ...
            anchor(
                site_url('baak/pembelajaran/presensi_dosen_list/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="Presensi Dosen" class="btn btn-info" '
            ),
            'id_trx_jadwal'
    ...
    function json_presensi_dosen_list($id_trx_jadwal)
    {
        ...
        $this->datatables->add_column(
            ...
            anchor(
                site_url('baak/pembelajaran/presensi_dosen_delete/$1'),
                '<i class="fa fa-trash"></i>',
                'data-toggle="tooltip" data-html="true" title="Presensi Dosen" class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure delete $1 ?  \')" '
            ),
            'id'
        );
        return $this->datatables->generate();
    ...
    function json_presensi_matakuliah_prodi($kode_prodi)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/pembelajaran/presensi_mahasiswa_list/$1'),
                '<i class="fa fa-list"></i>',
                'data-toggle="tooltip" data-html="true" title="Report Presensi mahasiswa" class="btn btn-info" '
            ),
            'id_trx_jadwal'
        );
        return $this->datatables->generate();
    ...
    function json_rekap_presensi_dosen()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/pembelajaran/rekap_presensi_dosen_up/$1'),
                '<i class="fa fa-level-up"></i>',
                'data-toggle="tooltip" data-html="true" title="Update Rekap" class="btn btn-danger" '
            ) . ' ' .
                anchor(
                    site_url('baak/pembelajaran/rekap_presensi_dosen_detail/$1'),
                    '<i class="fa fa-list"></i>',
                    'data-toggle="tooltip" data-html="true" title="Detail Rekap" class="btn btn-info" '
                ),
            'id_rekap'
        );
        return $this->datatables->generate();
    ...
    function json_kelas_perkuliahan()
    {
        ...
        $this->datatables->select('mata_kuliah_saji.periode, mata_kuliah_saji.id_matkul, id_kelas, id_kelas_feeder, kode_mata_kuliah, nama_mata_kuliah, kode_prodi,id_prodi, dikti_prodi.nama_program_studi, nama_kelas,feeder_info,nama_id_dosen,bahasan,concat(nama,"-",nidn) as dosen_feeder');
        $this->datatables->from('v_jadwal');
        $this->datatables->join('dikti_prodi', 'dikti_prodi.kode_program_studi=v_jadwal.kode_prodi');
        $this->datatables->join('mata_kuliah_saji', 'mata_kuliah_saji.id_matkul=v_jadwal.id_matkul and mata_kuliah_saji.periode=v_jadwal.periode ');
        $this->datatables->join('pegawai', 'pegawai.id=mata_kuliah_saji.id_dosen_pengampu', 'left');
    ...
    function json_list_history_magang()
    {
        ...
        $this->datatables->add_column(
            ...
            anchor(
                site_url('mahasiswa/magang/dashboard/$1'),
                '<i class="fa fa-book"></i>',
                'data-toggle="tooltip" data-html="true" title="dashboard" class="btn btn-info" '
            ),
            'periode'
        );
        return $this->datatables->generate();
    ...
    function json_list_periode_magang_mhs()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('mahasiswa/magang/daftar/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="daftar" class="btn btn-warning" '
            ) . " " .
                anchor(
                    site_url('mahasiswa/magang/dashboard/$1'),
                    '<i class="fa fa-book"></i>',
    ...
    function json_all_data_magang($periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/magang/penilaian/$1/$2'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Penilaian" class="btn btn-primary" '
            ) . " " .
                anchor(
                    site_url('baak/magang/plot_dosen/$1/$2'),
                    '<i class="fa fa-random"></i>',
                    'data-toggle="tooltip" data-html="true" title="plot pembimbing" class="btn btn-warning" '
                ),
            'id_trx,periode'
        );
        return $this->datatables->generate();
    ...
    function json_list_sidang_magang($periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/magang/sidang_magang_edit/$1/$2'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit" class="btn btn-info" '
            ) . ' | ' .
                anchor(
                    site_url('baak/magang/plot_jadwal_sidang/$1/$2'),
                    '<i class="fa fa-random"></i>',
                    'data-toggle="tooltip" data-html="true" title="plot Jadwal Sidang" class="btn btn-warning" '
                ),
            'id_trx,periode'
        );
        return $this->datatables->generate();
    ...
    function json_list_jadwal_sidang_magang($id_trx)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/magang/plot_sidang_magang/$1/$2'),
                '<i class="fa fa-random"></i>',
                'data-toggle="tooltip" data-html="true" title="plot jadwal sidang" class="btn btn-warning" '
            ) . " | " .
                anchor(
    ...
    function json_list_periode_magang()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/magang/periode_edit/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit" class="btn btn-warning" '
            ) . ' ' .
                anchor(
                    site_url('baak/magang/periode_rule/$1'),
                    '<i class="fa fa-key"></i>',
                    'data-toggle="tooltip" data-html="true" title="rule" class="btn btn-info" '
                ) . ' ' .
                anchor(
                    site_url('baak/magang/dashboard/$1'),
                    '<i class="fa fa-book"></i>',
                    'data-toggle="tooltip" data-html="true" title="dasboard" class="btn btn-info" '
                ),
            'periode'
        );
        return $this->datatables->generate();
    ...
    function json_periode_rule($periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/magang/delete_rule/$1'),
                '<i class="fa fa-trash"></i>',
                'data-toggle="tooltip" data-html="true" title="Delete" class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure  ?  \')" '
            ),
            'id_trx'
        );
        return $this->datatables->generate();
    ...
    function json_periode_rule_ta_s1($periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_s1/delete_rule/$1'),
                '<i class="fa fa-trash"></i>',
                'data-toggle="tooltip" data-html="true" title="Delete" class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure cancel suspend $1 ?  \')" '
            ),
            'id_trx'
        );
        return $this->datatables->generate();
    ...
    function json_periode_rule_wisuda($id_trx)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/wisuda/delete_rule/$1'),
                '<i class="fa fa-trash"></i>',
                'data-toggle="tooltip" data-html="true" title="Delete" class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure cancel suspend $1 ?  \')" '
            ),
            'id_wisuda_rule'
    ...
    function json_list_periode_s1()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_s1/periode_edit/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit" class="btn btn-warning" '
            ) . ' ' .
                anchor(
                    site_url('baak/tugas_akhir/ta_s1/periode_rule/$1'),
                    '<i class="fa fa-key"></i>',
                    'data-toggle="tooltip" data-html="true" title="rule" class="btn btn-info" '
                ) . ' ' .
                anchor(
                    site_url('baak/tugas_akhir/ta_s1/dashboard/$1'),
                    '<i class="fa fa-book"></i>',
                    'data-toggle="tooltip" data-html="true" title="dasboard" class="btn btn-info" '
                ),
            'periode'
    ...
    function json_list_periode_d3()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_d3/periode_edit/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit" class="btn btn-warning" '
            ) . ' ' .
                anchor(
                    site_url('baak/tugas_akhir/ta_d3/periode_rule/$1'),
                    '<i class="fa fa-key"></i>',
                    'data-toggle="tooltip" data-html="true" title="rule" class="btn btn-info" '
                ) . ' ' .
                anchor(
                    site_url('baak/tugas_akhir/ta_d3/dashboard/$1'),
                    '<i class="fa fa-book"></i>',
                    'data-toggle="tooltip" data-html="true" title="dasboard" class="btn btn-info" '
                ),
            'periode'
    ...
    function json_list_pendaftar_ta_s1($periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_s1/plot_dosen/$1/$2'),
                '<i class="fa fa-random"></i>',
                'data-toggle="tooltip" data-html="true" title="plot pembimbing" class="btn btn-warning" '
            ),
            'id_trx,periode'
    ...
    function json_all_data_ta_d3($periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_d3/plot_dosen/$1/$2'),
                '<i class="fa fa-random"></i>',
                'data-toggle="tooltip" data-html="true" title="plot pembimbing" class="btn btn-warning" '
            ),
            'id_trx,periode'
    ...
    function json_list_periode_s1_mhs()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('mahasiswa/ta_s1/daftar/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="daftar" class="btn btn-warning" '
            ) . " " .
                anchor(
                    site_url('mahasiswa/ta_s1/dashboard/$1'),
                    '<i class="fa fa-book"></i>',
                    'data-toggle="tooltip" data-html="true" title="dashboard" class="btn btn-info" '
                ),
            'periode'
    ...
    function json_list_periode_wisuda_mhs()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('mahasiswa/wisuda/daftar/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="daftar" class="btn btn-warning" '
            ) . " " .
                anchor(
                    site_url('mahasiswa/wisuda/dashboard/$1'),
                    '<i class="fa fa-book"></i>',
                    'data-toggle="tooltip" data-html="true" title="dashboard" class="btn btn-info" '
                ),
            'id_trx'
    ...
    function json_list_sidang_ta_s1($sidang, $periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_s1/sidang_ta_s1_edit/$1/$2'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit" class="btn btn-info" '
            ) . ' | ' .
                anchor(
                    site_url('baak/tugas_akhir/ta_s1/plot_jadwal_sidang/$1/$2'),
                    '<i class="fa fa-random"></i>',
                    'data-toggle="tooltip" data-html="true" title="plot Jadwal Sidang" class="btn btn-warning" '
                ),
            'id_trx,periode'
    ...
    function json_list_sidang_ta_d3($sidang, $periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_d3/sidang_ta_d3_edit/$1/$2'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit" class="btn btn-info" '
            ) . ' | ' .
                anchor(
                    site_url('baak/tugas_akhir/ta_d3/plot_jadwal_sidang/$1/$2'),
                    '<i class="fa fa-random"></i>',
                    'data-toggle="tooltip" data-html="true" title="plot Jadwal Sidang" class="btn btn-warning" '
                ),
            'id_trx,periode'
    ...
    function json_list_jadwal_sidang_ta_s1($id_trx)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_s1/plot_sidang_ta_s1/$1/$2'),
                '<i class="fa fa-random"></i>',
                'data-toggle="tooltip" data-html="true" title="plot jadwal sidang" class="btn btn-warning" '
            ) . " | " .
                anchor(
                    site_url('baak/tugas_akhir/ta_s1/penilaian/$1/$2'),
                    '<i class="fa fa-pencil"></i>',
                    'data-toggle="tooltip" data-html="true" title="Penilaian" class="btn btn-primary" '
                ),
            'id_trx,periode'
    ...
    function json_list_yudusium_s1($periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_s1/yudisium_edit/$1/$2'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="edit yudisium" class="btn btn-warning" '
            ) . " | " .
                anchor(
                    site_url('baak/tugas_akhir/ta_s1/yudisium_daftar/$1/$2'),
                    '<i class="fa fa-user"></i>',
                    'data-toggle="tooltip" data-html="true" title="pendaftar" class="btn btn-primary" '
                ),
            'id,periode'
        );
        return $this->datatables->generate();
    ...
    function json_list_yudisium_daftar($id_trx)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_s1/daftar_yudisium/$1/$2'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="Riwayat perkuliahan" class="btn btn-warning" '
            ),
            'id_trx,periode'
        );
        return $this->datatables->generate();
    ...
    function json_list_periode_wisuda()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/wisuda/periode_wisuda_edit/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit" class="btn btn-warning" '
            ) . ' ' .
                anchor(
                    site_url('baak/wisuda/periode_rule/$1'),
                    '<i class="fa fa-key"></i>',
                    'data-toggle="tooltip" data-html="true" title="rule" class="btn btn-info" '
                ) . ' ' .
                anchor(
                    site_url('baak/wisuda/list_pendaftar/$1'),
                    '<i class="fa fa-book"></i>',
                    'data-toggle="tooltip" data-html="true" title="dasboard" class="btn btn-info" '
                ),
            'id_trx'
    ...
    function json_list_trankript()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/transkript/cetak_trankript/$1'),
                'Transkrip',
                'target="_blank" data-toggle="tooltip" data-html="true" title="Cetak Transkript" class="btn btn-warning" '
            ) . ' ' .
                anchor(
                    site_url('baak/wisuda/periode_rule/$1'),
                    'Ijazah',
                    'target="_blank" data-toggle="tooltip" data-html="true" title="Cetak Ijazah" class="btn btn-warning" '
                ) . ' ' .
                anchor(
                    site_url('baak/wisuda/list_pendaftar/$1'),
                    '<i class="fa fa-upload"></i>',
                    'data-toggle="tooltip" data-html="true" title="upload" class="btn btn-info" '
                ),
            'nim'
        );
        return $this->datatables->generate();
    ...
    function json_periode_rule_ta_d3($periode)
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/tugas_akhir/ta_d3/delete_rule/$1'),
                '<i class="fa fa-trash"></i>',
                'data-toggle="tooltip" data-html="true" title="Delete" class="btn btn-danger" onclick="javasciprt: return confirm(\'Are You Sure cancel suspend $1 ?  \')" '
            ),
            'id_trx'
    ...
    function json_list_periode_d3_mhs()
    {
        ...
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('mahasiswa/ta_d3/daftar/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="daftar" class="btn btn-warning" '
            ) . " " .
                anchor(
                    site_url('mahasiswa/ta_d3/dashboard/$1'),
                    '<i class="fa fa-book"></i>',
                    'data-toggle="tooltip" data-html="true" title="dashboard" class="btn btn-info" '
                ),
            'periode'
    ...
    function json_mahasiswa_perwalian_by_nim($nim)
    {
        $this->datatables->select('id_trx,topik_pewralian,keterangan,input_date,periode,email_dosen,nim');
        $this->datatables->from('mahasiswa_perwalian');
		$this->datatables->where('nim', $nim);
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/mahasiswa/perwalian_edit/$1'),
                '<i class="fa fa-edit"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit Perwalian" class="btn btn-warning"'
            ),
            'id_trx'
        );
        return $this->datatables->generate();
    ...
    function json_list_perwalian_by_mahasiswa($nim)
    {
        $this->datatables->select('id_trx,nim,email_dosen,periode,input_date,keterangan,topik_pewralian');
        $this->datatables->from('mahasiswa_perwalian');
        $this->datatables->where('nim', $nim);
        return $this->datatables->generate();
    }

    function json_list_jadwal_by_mahasiswa($nim, $periode)
    {
        $this->datatables->select('
        pegawai.nama,
        ...
        kelas.nama_kelas,
        waktu_kulia.waktu,
        mata_kuliah_jadwal.hari,
        mata_kuliah_jadwal.ruang
        ');
        $this->datatables->from('mahasiswa');
        $this->datatables->join('frs_mhs_mk', 'frs_mhs_mk.id_registrasi_mahasiswa = mahasiswa.id_registrasi_mahasiswa');
        $this->datatables->join('mata_kuliah_jadwal', 'mata_kuliah_jadwal.id_matkul = frs_mhs_mk.id_matkul');
        $this->datatables->join('waktu_kulia', 'waktu_kulia.id = mata_kuliah_jadwal.waktu');
        $this->datatables->join('pegawai', 'pegawai.id = mata_kuliah_jadwal.id_dosen');
        $this->datatables->join('mata_kuliah', 'mata_kuliah.id_matkul = mata_kuliah_jadwal.id_matkul');
        $this->datatables->join('kelas', 'kelas.id_kelas = mahasiswa.id_kelas');
        $this->datatables->where('nim', $nim);
        $this->datatables->where('frs_mhs_mk.periode', $periode);
        $this->datatables->where('frs_mhs_mk.status_frs', 'setujui');
        $this->datatables->where('mata_kuliah_jadwal.periode', $periode);
        return $this->datatables->generate();
    }


    function json_list_jadwal_by_dosen($id_dosen, $periode)
    {
        $this->datatables->select('
        mata_kuliah.nama_mata_kuliah,
        mata_kuliah.kode_mata_kuliah,
        ...
        mata_kuliah_jadwal.ruang
        ');
        $this->datatables->from('mata_kuliah_jadwal');
        $this->datatables->join('waktu_kulia', 'waktu_kulia.id = mata_kuliah_jadwal.waktu');
        $this->datatables->join('mata_kuliah', 'mata_kuliah.id_matkul = mata_kuliah_jadwal.id_matkul');
        $this->datatables->join('kelas', 'kelas.id_kelas = mata_kuliah_jadwal.id_kelas');
        $this->datatables->where('mata_kuliah_jadwal.id_dosen', $id_dosen);
        $this->datatables->where('mata_kuliah_jadwal.periode', $periode);
        return $this->datatables->generate();
    }

    function json_perkuliahan_periode()
    {
        $this->datatables->select('id_semester,id_tahun_ajaran,nama_semester');
        $this->datatables->from('v_dikti_semester');
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/baak/perkuliahan_periode_hide/$1'),
                '<i class="fa fa-eye-slash"></i>',
                'data-toggle="tooltip" data-html="true" title="Hide" class="btn btn-warning"'
            ),
            'id_semester'
        );
        // $this->datatables->where('mata_kuliah_jadwal.id_dosen', $id_dosen);
    ...
    function json_unhide_periode()
    {
        $this->datatables->select('dikti_semester.id_semester,id_tahun_ajaran,nama_semester');
        $this->datatables->from('dikti_semester');
        $this->datatables->join('dikti_semester_hide', 'dikti_semester_hide.id_periode = dikti_semester.id_semester');
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/baak/perkuliahan_periode_unhide/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="Unhide" class="btn btn-warning"'
            ),
            'id_semester'
        );
        // $this->datatables->where('mata_kuliah_jadwal.id_dosen', $id_dosen);
    ...
    function json_mahasiswa_aktif_by_nim($nim)
    {
        $this->datatables->select('id,id_uuid,nomer_aktif,nim,periode');
        $this->datatables->from('list_mahasiswa_aktif');
        $this->datatables->where('nim', $nim);
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('welcome/surat_keterangan_mahasiswa_aktif/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="Unhide" class="btn btn-warning" target="_blank"'
            ),
            'id_uuid'
        );
        return $this->datatables->generate();
    ...
    function json_list_permohonan_magang()
    {
        $this->datatables->select('
        id,nim,nama_penerima,nama_perusahaan,tujuan,periode,
        (CASE
            WHEN status = "0" THEN " Validasi Permohonan"
            WHEN status = "1" THEN "Acc Permohonan"
            WHEN status = "2" THEN "Tolak Permohonan"
            ELSE "175 or under"
        END) AS status
        ');
        $this->datatables->from('permohonan_magang');
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('baak/magang/edit_permohonan_magang/$1'),
                '<i class="fa fa-pencil"></i>',
                'data-toggle="tooltip" data-html="true" title="Edit" class="btn btn-warning" '
            ) . " " .
                anchor(
                    site_url('baak/magang/delete_permohonan_magang/$1'),
                    '<i class="fa fa-trash"></i>',
                    'data-toggle="tooltip" data-html="true" title="Permohonan magang delete" class="btn btn-danger" onclick="javasciprt: return confirm(\'Apakah Anda Yakin \')"'
                ),
            'id'
        );
        return $this->datatables->generate();
    ...
    function json_list_skpi_by_mahasiswa($mahasiswa)
    {
        // $this->datatables->select('
        // skpi_list.id AS id,skpi_list.draft_skpi,' . $mahasiswa->nim . ' as nim,
        // (CASE
        ...
        //     WHEN skpi_mahasiswa.status = "4" THEN "Perbaikan SKPI"
        //     ELSE "Belum Upload SKPI"
        // END) AS status,skpi_mahasiswa.`file` as file
        // ');
        // $this->datatables->from('skpi_list');
        // $this->datatables->join('skpi_mahasiswa', 'skpi_list.id = skpi_mahasiswa.id_draft_skpi AND skpi_mahasiswa.nim = ' . $mahasiswa->nim, 'left');
        // $this->datatables->where('skpi_list.kode_prodi', $mahasiswa->kode_prodi);
        ...
        $this->datatables->where('skpi_prodi.kode_prodi', $mahasiswa->kode_prodi);

        $this->datatables->add_column(
            'action',
            anchor(
                site_url('/baak/mahasiswa/skpi_edit/$1/$2'),
                '<i class="fa fa-pencil"></i>',
    ...
    function json_list_mbkm()
    {
        ...
        tanggal_akhir,
        (CASE
            WHEN mbkm.status = "0" THEN " Tidak Lulus"
            WHEN mbkm.status = "1" THEN "Pengajuan"
            WHEN mbkm.status = "2" THEN "Lulus"
        END) AS status
        ');
        $this->datatables->from('mbkm');
        $this->datatables->join('mahasiswa', 'mahasiswa.nim=mbkm.nim');
        // $this->datatables->where('mbkm.nim', $this->session->userdata('username'));
        $this->datatables->add_column(
            'surat_rekomendasi',
            anchor(
    ...
    function json_surat_kelulusan($nim)
    {
        $this->datatables->select('id,uuid,nomer_aktif,nim,periode');
        $this->datatables->from('list_surat_kelulusan');
        $this->datatables->where('nim', $nim);
        $this->datatables->add_column(
            'action',
            anchor(
                site_url('welcome/surat_kelulusan/$1'),
                '<i class="fa fa-eye"></i>',
                'data-toggle="tooltip" data-html="true" title="Unhide" class="btn btn-warning" target="_blank"'
            ),
            'uuid'
