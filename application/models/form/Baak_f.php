...
{ //baku
    ...
    function cuti_validate($id_uuid)
    {
        $form_detail = array(
            'action' => base_url('baak/mahasiswa/cuti_validate_action/' . $id_uuid),
            'form_detail' => 'Cuti Validate',
        );
        $data_isi = array(
    ...
    function tolak_yudisium($id_trx, $data_file)
    {
        $form_detail = array(
            'action' => base_url('baak/tugas_akhir/ta_s1/tolak_yudisium_action/' . $id_trx),
            'form_detail' => 'Tolak Ajuan Yudisium <br><hr>
            Yudisium info : ' . $data_file->nim . "/ " . $data_file->nama . "/ HP :" . $data_file->handphone . "/ " . $data_file->judul_indo,
        );
        $data_isi = array(
    ...
    function set_suspend_mahasiswa_select()
    {
        $form_detail = array(
            'action' => base_url('baak/pembelajaran/add_suspend_mahasiswa_list'),
            'form_detail' => 'Select Program Studi',
            // 'add_action'=>'Get Token',
            // 'add_action_url'=>base_url('admin/feeder/f_GetToken'),
            //'action_status'=>$action,
        );
    ...
    function perwalian_add($nim)
    {
        if ($this->session->userdata('role') == 'dosen' || $this->session->userdata('role') == 'pegawai_baak') {
            $form_detail = array(
                'action' => base_url('baak/mahasiswa/perwalian_add_action/' . $nim),
                'form_detail' => 'Add Perwalian ' . $nim,
                'add_action' => 'Back',
                'add_action_url' => base_url('baak/mahasiswa/perwalian/' . $nim),
                'action_status' => 'back',
            );
        } else {
            $form_detail = array(
                'action' => base_url('/mahasiswa/perkuliahan/perwalian_add_action/'),
                'form_detail' => 'Add Perwalian ' . $nim,
                'add_action' => 'Back',
                'add_action_url' => base_url('/mahasiswa/perkuliahan/perwalian/'),
                'action_status' => 'back',
            );
        }
        ...
        $data_isi = array(
            [
                'kode_form' => 'tanggal_perwalian',
                'nama_form' => 'Tanggal Perwalian',
                'tipe' => 'date',
                'placeholder' => 'Inputkan Tanggal Perwalian',
                'required' => '1',
                'readonly' => '0',
            ],
            [
                'kode_form' => 'topik_perwalian',
                'nama_form' => 'Topik perwalian',
                'tipe' => 'text',
                'placeholder' => 'Inputkan Topik perwalian',
                'required' => '1',
                'readonly' => '0',
            ],
            [
                'kode_form' => 'konten_perwalian',
                'nama_form' => 'konten perwalian',
                'tipe' => 'text',
                'placeholder' => 'Inputkan Konten perwalian',
                'required' => '1',
                'readonly' => '0',
            ],
        );
    ...
    function perwalian_edit($id, $nim)
    {
        $form_detail = array(
            'action' => base_url('baak/mahasiswa/perwalian_edit_action/' . $id . '/' . $nim),
            'form_detail' => 'Add Perwalian ' . $id,
            'add_action' => 'Back',
            'add_action_url' => base_url('baak/mahasiswa/perwalian/' . $nim),
            'action_status' => 'back',
        );
    ...
    function add_mahasiswa_aktif()
    {
        $form_detail = array(
            'action' => base_url('/mahasiswa/perkuliahan/action_add_mahasiswa_aktif'),
            'form_detail' => 'Add Surat Mahasiswa Aktif',
            // 'add_action'=>'Get Token',
            // 'add_action_url'=>base_url('admin/feeder/f_GetToken'),
            //'action_status'=>$action,
        );
        $data_isi = array(
            [
                ...
                'nama_form' => 'Periode',
                'tipe' => 'select2',
                'select_data' => base_url('mahasiswa/perkuliahan/json_id_periode/'),
                'placeholder' => 'Periode',
                'required' => '1',
                'readonly' => '0',
            ],
    ...
    {
        $form_detail = array(
            'action' => base_url('baak/magang/edit_permohonan_magang_action/' . $id),
        ...
        $data_isi = array(
            ...
            [
                ...
                'select_data' => [
                    ...
                    ['id' => '0', 'value' => 'Validasi Permohonan'],
                    ['id' => '1', 'value' => 'Acc Permohonan'],
                    ['id' => '2', 'value' => 'Tolak Permohonan'],
                ],
                'placeholder' => 'status',
                'required' => '1',
                'readonly' => '0',
            ...
            [
                'kode_form' => 'info',
                'nama_form' => 'Info (Tolak/Acc) *Opsional',
                'tipe' => 'text',
                'placeholder' => 'Info',
                'required' => '0',
                'readonly' => '0',
    ...
    function pengesahan_aktif()
    {
		$link = base_url('/baak/baak/download_surat_Aaktif/' ); //" base_url('/assets/berkas/magang/'.".$data_masters->berkas.")";
        
        $form_detail = array(
            'action' => base_url('baak/baak/edit_aktif_action/' ),
            'form_detail' => 'Pengesahan Magang <a class="btn btn-info" target="_blank" href="' . $link . '">Lihat Surat</a>',
        );
        $data_isi = array(
            [
                'kode_form' => 'jabatan',
    ...
    {
		$form_detail = array(
            'action' => base_url('baak/pembelajaran/cetak_kartu_ujian_action'),
            'form_detail' => 'Cetak Bulk kartu Ujian',
        );
		...
		$data_isi = array(
			...
			[
                ...
                'kode_form' => 'id_periode_masuk',
                'nama_form' => 'Periode Masuk Mahasiswa',
                'tipe' => 'select2',
                'select_data' => base_url('baak/data_json/json_id_periode/'),
                'placeholder' => 'live',
                'required' => '1',
    ...
    function pengesahan($periode)
    {
		$link = base_url('/baak/magang/download_surat_permohonan/' . $periode); //" base_url('/assets/berkas/magang/'.".$data_masters->berkas.")";
        
        $form_detail = array(
            'action' => base_url('baak/magang/edit_pengesahan_action/' . $periode),
            'form_detail' => 'Pengesahan Magang <a class="btn btn-info" target="_blank" href="' . $link . '">Lihat Surat</a>',
        );
        $data_isi = array(
            [
